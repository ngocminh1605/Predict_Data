rule save_data:
    input:
        ...
        search_rfdistance = f"{iqtree_tree_inference_dir}inference.rfdist",
        ...
        eval_rfdistance = f"{iqtree_tree_eval_dir}eval.rfdist",

        # Plausible tree RFDistance logs
        plausible_rfdistance = f"{iqtree_tree_eval_dir}plausible.rfdist",
        ...
        parsimony_rfdistance = f"{output_files_parsimony_trees}parsimony.rfdist",
    output:
